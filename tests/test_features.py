...
class TestTemporalFeatureEngineer:
    ...
    def sample_transactions(self):
        ...
        data = {
            ...
            "merchant_id": np.random.choice(["M001", "M002", "M003", "M004"], n_transactions),
...
class TestGraphFeatureEngineer:
    ...
    def test_risk_propagation(self, graph_engineer, sample_transactions):
        ...
        features = graph_engineer.compute_all_features(
            sample_transactions,
            merchant_risk_scores=merchant_risk
        )
        ...
        c001_exposure = features[features["customer_id"] == "C001"]["merchant_risk_exposure"].values[0]
